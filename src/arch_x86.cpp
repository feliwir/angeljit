...
int angeljit::compileFunc(asDWORD * bc, asDWORD * end, std::shared_ptr<Assembler>& assembler, JitRuntime & runtime)
{
	Error err;

	if (assembler == nullptr)
		assembler = std::make_shared<X86Assembler>(&runtime);
	...
	//Function prologue
	X86GpReg arg0, arg1,unmut1, unmut2, unmut3, unmut4,sp;
	#if ASMJIT_ARCH_X64
	#if ASMJIT_OS_LINUX
	arg0 = x86::rdi; 
	arg1 = x86::rsi;
